(() => {
    ...
    function i(e, a, i, l, r) {
        ...
        if (!c) return (console.error('Could not find or create callback form element'), null);
        ...
        return (
            ...
            (function (e, n) {
                        ...
                        e.forEach(function (e) {
                            ...
                            ((n.className = 'retell-country-option'),
                                ...
                                (n.onkeydown = function (n) {
                                    ('Enter' !== n.key && ' ' !== n.key) || (n.preventDefault(), f(e));
                                }),
                                d.appendChild(n));
                        }));
                }
                ...
                ((a.onclick = function (e) {
                    if ((e.stopPropagation(), a.classList.contains('open'))) (a.classList.remove('open'), (r.style.display = 'none'), a.setAttribute('aria-expanded', 'false'));
                    else {
                        (a.classList.add('open'), (r.style.display = 'block'), a.setAttribute('aria-expanded', 'true'));
                        var n = a.getBoundingClientRect();
                        ((r.style.position = 'fixed'), (r.style.top = n.top - 304 + 'px'), (r.style.left = n.left + 'px'), (r.style.width = '280px'), c.focus());
                    }
                }),
                    (a.onkeydown = function (e) {
                        ('Enter' !== e.key && ' ' !== e.key && 'ArrowDown' !== e.key) || (e.preventDefault(), a.click());
                    }));
                ...
                ((c.oninput = function (e) {
                    ...
                    p(
                        s.filter(function (e) {
                            return e.name.toLowerCase().includes(n) || e.code.toLowerCase().includes(n) || (e.dial_code && e.dial_code.toLowerCase().includes(n));
                        }),
                    );
                }),
                    ...
                    document.addEventListener('click', function () {
                        (a.classList.remove('open'), (r.style.display = 'none'), a.setAttribute('aria-expanded', 'false'));
                    }),
                    p(s),
                    f(u));
            })(e, r),
    ...
    function r() {
                ...
                c(
                    ...
                    (function (t, o, a) {
                        ...
                        function p(t, o) {
                            for (r = t, c = o, n = 0; !m && d && !a && n < s.length; n++) {
                                var a,
                                    ...
                                    f = i[2];
                                t > 3
                                    ? (a = f === o) && ((c = i[(r = i[4]) ? 5 : ((r = 3), 3)]), (i[4] = i[5] = e))
                                    : i[0] <= p &&
                                      ((a = t < 2 && p < i[1])
                                          ? ((r = 0), (u.v = o), (u.n = i[1]))
                                          : p < f && (a = t < 3 || i[0] > o || o > f) && ((i[4] = t), (i[5] = o), (u.n = f), (r = 0)));
                            }
                            if (a || t > 1) return l;
                            throw ((m = !0), o);
                        }
                        return function (a, s, f) {
                            ...
                            for (m && 1 === s && p(s, f), r = s, c = f; (n = r < 2 ? e : c) || !m; ) {
                                i || (r ? (r < 3 ? (r > 1 && (u.n = -1), p(r, c)) : (u.n = c)) : (u.v = c));
                                try {
                                    if (((d = 2), i)) {
                                        if ((r || (a = 'next'), (n = i[a]))) {
                                            ...
                                            if (!n.done) return n;
                                            ((c = n.value), r < 2 && (r = 0));
                                        } else (1 === r && (n = i.return) && n.call(i), r < 2 && ((c = TypeError("The iterator does not provide a '" + a + "' method")), (r = 1)));
                                        i = e;
                                    } else if ((n = (m = u.n < 0) ? c : t.call(o, u)) !== l) break;
                                } catch (n) {
                                    ((i = e), (r = 1), (c = n));
                                } finally {
                                    d = 1;
        ...
        function f(e) {
            return (Object.setPrototypeOf ? Object.setPrototypeOf(e, m) : ((e.__proto__ = m), c(e, a, 'GeneratorFunction')), (e.prototype = Object.create(p)), e);
        }
        return (
            (s.prototype = m),
            c(p, 'constructor', m),
                                ...
                                switch (e.n) {
                                    case 0:
                                        return (
                                            ...
                                            a && Object.keys(a).length > 0 && (l.retell_llm_dynamic_variables = a),
                                            (c = {
                                    ...
                                    case 1:
                                        ...
                                        return ((s = 'Unknown error'), (e.p = 2), (e.n = 3), d.json());
                                    case 3:
                                ...
                                switch (e.n) {
                                    case 0:
                                        return (
                                            ...
                                            (a = b.length > 3 && void 0 !== b[3] ? b[3] : null) && (s.override_agent_id = a),
                                            i && (s.override_agent_version = i),
                                            l && (s.metadata = l),
                                            c && Object.keys(c).length > 0 && (s.retell_llm_dynamic_variables = c),
                                            (u = {
                                                'Content-Type': 'application/json',
                                                Authorization: 'Bearer '.concat(o),
                                            }),
                                    ...
                                    case 1:
                                        ...
                                        return ((f = 'Unknown error'), (e.p = 2), (e.n = 3), p.json());
                                    case 3:
    ...
    function C(e) {
        ...
        var n = new Date(),
            ...
            i = Math.floor(a / 60),
            l = Math.floor(i / 60);
        return Math.floor(l / 24) >= 1 ? t.toISOString().slice(0, 10) : l >= 1 ? ''.concat(l, 'h ago') : i >= 1 ? ''.concat(i, ' minutes ago') : 'just now';
    }
    function S(e) {
        return (
            (S =
        ...
        return (
                ...
                if (null != t) {
                    ...
                    try {
                        if (((i = (t = t.call(e)).next), 0 === n)) {
                            ...
                            c = !1;
                        } else for (; !(c = (o = i.call(t)).done) && (r.push(o.value), r.length !== n); c = !0);
                    } catch (e) {
                        ((d = !0), (a = e));
                    } finally {
                        try {
            ...
            (function (e, n) {
                if (e) {
                    ...
                    return (
                        'Object' === t && e.constructor && (t = e.constructor.name),
                        'Map' === t || 'Set' === t ? Array.from(e) : 'Arguments' === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? M(e, n) : void 0
                    );
                }
            })(e, n) ||
            (function () {
    ...
    function B() {
        ...
        function u(e) {
            return (Object.setPrototypeOf ? Object.setPrototypeOf(e, d) : ((e.__proto__ = d), A(e, a, 'GeneratorFunction')), (e.prototype = Object.create(m)), e);
        }
        return (
            (c.prototype = d),
            A(m, 'constructor', d),
                    ...
                    if ('callback' !== c || d) {
                        ...
                        if (M)
                            try {
                                ...
                                console.error('Retell Widget: Failed to parse data-dynamic JSON', e);
                            }
                        var presetQuestionsAttr = t.getAttribute('data-preset-questions'),
                            presetQuestions = [];
                        if (presetQuestionsAttr)
                            try {
                                presetQuestions = JSON.parse(presetQuestionsAttr);
                                if (!Array.isArray(presetQuestions)) {
                                    console.error('Retell Widget: data-preset-questions must be a JSON array');
                                    presetQuestions = [];
                                }
                            } catch (e) {
                                console.error('Retell Widget: Failed to parse data-preset-questions JSON', e);
                            }
                        var presetQuestionsShown = false;
                        var L,
                            ...
                            K = (function (e) {
                                ...
                                ((S.style.position = 'fixed'), (S.style.bottom = '24px'), (S.style.right = '24px'), (S.style.zIndex = '999999'), document.body.appendChild(S));
    ...
    .retell-msg.agent code { background: #e2e8f0; padding: 1px 4px; border-radius: 3px; font-size: 0.9em; }\n    .retell-agent-logo { width: 28px; height: 28px; margin-right: 8px; margin-top: 2px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; }\n    .retell-footer {\n      font-size: 13px;\n      color: #b0b0b0;\n      text-align: left;\n      padding: 6px 18px 8px 18px;\n      background: #fff;\n      border-top: 1px solid #f0f0f0;\n      letter-spacing: 0.01em;\n      position: static;\n    }\n    .retell-footer strong { color: #0d1123; }\n    .retell-modal { position: absolute; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.18); display: flex; align-items: center; justify-content: center; z-index: 100; }\n    .retell-modal-content { background: #fff; border-radius: 12px; padding: 32px 28px 24px 28px; box-shadow: 0 4px 24px rgba(0,0,0,0.18); text-align: center; min-width: 260px; }\n    .retell-modal-content p { font-size: 19px; margin-bottom: 24px; color: #0d1123; }\n    .retell-modal-btn-row { display: flex; flex-direction: column; gap: 12px; }\n    .retell-modal-btn { font-size: 16px; padding: 10px 0; border-radius: 8px; border: 1px solid #d1d5db; background: #fff; color: #0d1123; cursor: pointer; transition: background 0.2s, border 0.2s; display: flex; align-items: center; justify-content: center; gap: 8px; }\n    .retell-modal-btn.selected, .retell-modal-btn:hover { background: #e0e7ef; border: 1.5px solid #0d1123; }\n    .retell-modal-btn svg { font-size: 18px; }\n    @media (max-width: 600px) {\n      .retell-chat-window {\n      width: 90vw !important;\n      height: ',
                                    ...
                                    .concat(
                                        w,
                                        ";\n      filter: brightness(0.9);\n    }\n    .retell-callback-form .retell-send-btn:disabled {\n      background: #9ca3af;\n      color: #ffffff;\n      cursor: not-allowed;\n      opacity: 0.6;\n    }\n    .retell-maybe-later {\n      text-align: center;\n      font-family: 'Inter', Arial, sans-serif;\n      font-size: 12px;\n      color: #525866;\n      cursor: pointer;\n      line-height: 16px;\n    }\n    .retell-maybe-later:hover {\n      color: #0e121b;\n    }\n\n    /* Success Widget Styles */\n    .retell-success-container {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      justify-content: center;\n      gap: 24px;\n      padding: 16px;\n      height: 100%;\n      min-height: 314px;\n    }\n\n    .retell-success-icon {\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      width: 42px;\n      height: 42px;\n    }\n\n    .retell-success-content {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      gap: 2px;\n      text-align: center;\n      max-width: 260px;\n    }\n\n    .retell-success-title {\n      font-family: 'Inter', sans-serif;\n      font-size: 16px;\n      font-weight: 500;\n      line-height: 24px;\n      color: #0e121b;\n      margin: 0;\n      letter-spacing: -0.176px;\n    }\n\n    .retell-success-subtitle {\n      font-family: 'Inter', sans-serif;\n      font-size: 14px;\n      font-weight: 400;\n      line-height: 20px;\n      color: #1f2329;\n      margin: 0;\n      text-align: center;\n      letter-spacing: -0.084px;\n    }\n\n    .retell-success-actions {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      gap: 8px;\n      width: 100%;\n    }\n\n    .retell-got-it-btn {\n      background: #ffffff;\n      border: 1px solid #e1e4ea;\n      border-radius: 10px;\n      padding: 10px 16px;\n      font-family: 'Inter', sans-serif;\n      font-size: 14px;\n      font-weight: 500;\n      line-height: 20px;\n      color: #525866;\n      cursor: pointer;\n      box-shadow: 0px 1px 2px 0px rgba(10,13,20,0.03);\n      transition: all 0.2s ease;\n      width: 100%;\n      max-width: 360px;\n    }\n\n    .retell-got-it-btn:hover {\n      background: #f8f9fa;\n      border-color: #d1d5db;\n    }\n\n    .retell-got-it-btn:active {\n      transform: translateY(1px);\n    }\n\n    /* Error Message Styles */\n    .retell-error-message {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      justify-content: center;\n      gap: 24px;\n      padding: 16px;\n      height: 100%;\n      min-height: 314px;\n    }\n\n    .retell-error-icon {\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      width: 42px;\n      height: 42px;\n      font-size: 32px;\n    }\n\n    .retell-error-content {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      gap: 2px;\n      text-align: center;\n      max-width: 260px;\n    }\n\n    .retell-error-title {\n      font-family: 'Inter', sans-serif;\n      font-size: 16px;\n      font-weight: 500;\n      line-height: 24px;\n      color: #0e121b;\n      margin: 0;\n      letter-spacing: -0.176px;\n    }\n\n    .retell-error-subtitle {\n      font-family: 'Inter', sans-serif;\n      font-size: 14px;\n      font-weight: 400;\n      line-height: 20px;\n      color: #1f2329;\n      margin: 0;\n      text-align: center;\n      letter-spacing: -0.084px;\n    }\n\n    .retell-error-actions {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      gap: 8px;\n      width: 100%;\n    }\n .retell-loading-indicator {display: flex;align-items: center;gap: 5px;background: #F2F5F8;color: #0E121B;align-self: flex-start;border-radius: 16px 16px 16px 4px;padding: 13px 16px;margin-left: 36px;min-width: 0;} .retell-loading-indicator .retell-dot {  width: 8px; height: 8px;background-color: #99A0AE;border-radius: 50%;animation: bounce 1.4s infinite ease-in-out both;}.retell-loading-indicator .retell-dot:nth-child(1) {animation-delay: -0.32s;}.retell-loading-indicator .retell-dot:nth-child(2) {animation-delay: -0.16s;}@keyframes bounce { 0%, 80%, 100% {transform: scale(0);}40% {transform: scale(1.0);}}.retell-preset-questions { display: flex; flex-wrap: wrap; gap: 8px; margin: 12px 0 12px 36px; }.retell-preset-question-bubble { background: #ffffff; border: 1px solid #E1E4EA; border-radius: 18px; padding: 8px 16px; font-family: 'Inter', Arial, sans-serif; font-size: 13px; color: #525866; cursor: pointer; transition: all 0.2s ease; max-width: 100%; word-wrap: break-word; }.retell-preset-question-bubble:hover { background: #F2F5F8; border-color: #CACFD8; color: #0E121B; }",
                                    )),
                                    I.appendChild(M),
                                    (I.innerHTML += '\n    <div class="retell-fab" id="retell-fab" title="'
                                        .concat('callback' === m ? 'Request Callback' : 'Chat', '">')
                                        .concat(t, '</div>\n    <div class="retell-chat-window" id="retell-chat" style="display:none;">\n      ')
                                        .concat(
                                            'callback' === m
                                                ? '<div class="retell-callback-form" id="retell-callback-form">'.concat(n, '</div>')
                                        ...
                                        .concat(
                                            j || "Hello! I'm here to help you. How can I assist you today?",
                                ...
                                if ('callback' === m) {
                                    ...
                                    ((E = I.getElementById('retell-close')),
                                        ...
                                        (E.onclick = f),
                                        (z.onclick = function () {
                                            'flex' === O.style.display ? (O.style.display = 'none') : (O.style.display = 'flex');
                                        }),
                                        (H.onsubmit = h));
                                return (
                                    ...
                                    $.addEventListener('click', function (e) {
                                        e.target === te || e.target.closest('.retell-ai-message-close') || u();
                                    }),
                                    {
                                        widgetContainer: S,
                                        shadow: I,
                        ...
                        (K.aiMessageClose, K.callbackForm, K.firstNameInput, K.lastNameInput, K.phoneInput, K.privacyCheckbox, K.callbackSubmit, K.maybeLaterBtn);
                        ((L = E(
                            B().m(function e() {
                    ...
                    } else console.error("Retell Widget: data-phone-number attribute is required when data-widget='callback'.");
                } else console.error('Retell Widget: data-public-key attribute is required.');
            } else console.error("Retell Widget: Script tag with id 'syntalia-widget' not found.");
            ...
            function ae() {
                !(function (e, n, t, o) {
                    e.innerHTML = '';
                    var a = [];
                    var hasUserMessage = n.some(function (msg) {
                        return 'user' === msg.role;
                    });
                    var firstAgentMessageRendered = false;
                    if (
                                ...
                                (l && 'agent' === l.role) ||
                                    (a.forEach(function (n, o) {
                                        ...
                                        ((a.className = 'retell-msg agent-row'),
                                            0 === o
                                                ? (a.innerHTML = "<span class='retell-agent-logo'>".concat(t, "</span><div class='retell-msg agent'>").concat(formatAgentMessage(n.content), '</div>'))
                                                : ((a.className = 'retell-msg agent-row consecutive'),
                                                  (a.innerHTML = "<div class='retell-msg agent' style='margin-left: 36px;'>".concat(formatAgentMessage(n.content), '</div>'))),
                                            e.appendChild(a));
                                    }),
                                    (a = []),
                                    (firstAgentMessageRendered = true));
                                // Show preset questions after first agent message if no user messages yet
                                if (firstAgentMessageRendered && !hasUserMessage && !presetQuestionsShown && presetQuestions.length > 0) {
                                    var presetContainer = document.createElement('div');
                                    presetContainer.className = 'retell-preset-questions';
                                    presetContainer.id = 'retell-preset-questions';
                                    presetQuestions.forEach(function (question) {
                                        var bubble = document.createElement('button');
                                        bubble.className = 'retell-preset-question-bubble';
                                        bubble.textContent = question;
                                        bubble.onclick = function () {
                                            presetQuestionsShown = true;
                                            var presetEl = U.getElementById('retell-preset-questions');
                                            if (presetEl) presetEl.remove();
                                            Y.value = question;
                                            J.dispatchEvent(new Event('submit', { bubbles: true, cancelable: true }));
                                        };
                                        presetContainer.appendChild(bubble);
                                    });
                                    e.appendChild(presetContainer);
                                }
                            } else {
                                var r = document.createElement('div');
                                ((r.className = 'retell-msg user'), (r.textContent = o.content), e.appendChild(r));
                            }
                        }),
                        o)
                    ) {
                ...
                })(W, V, S, arguments.length > 0 && void 0 !== arguments[0] && arguments[0]);
            }
            function ie() {
                    ...
                    ((e.innerHTML = ''),
                        n.length
                            ? n.forEach(function (n) {
                                  ...
                                  ((l.className = 'retell-chat-list-item' + (n.id === t ? ' selected' : '')),
                            ...
                            : (e.innerHTML = '<div style="color:#888;text-align:center;margin-top:24px;">No previous chats</div>'));
                })(X, D, R, C, se, e);
            }
            function le() {
                                ...
                                for (;;)
                                    switch (e.n) {
                                        ...
                                        case 1:
                                            ...
                                            return (console.error('Retell Widget: grecaptcha is not defined. Make sure to include the reCAPTCHA script.'), e.a(2, null));
                                        case 2:
                                            if (((e.p = 2), !grecaptcha.execute)) {
                                                e.n = 7;
                                                break;
                                            }
                                            return ((e.p = 3), (e.n = 4), grecaptcha.execute(w, { action: 'submit' }));
                                        case 4:
                                            if (!(n = e.v)) {
                                                e.n = 5;
                                                break;
                                        ...
                                        case 6:
                                            ((e.p = 6), e.v);
                                        case 7:
                                            return (console.error('Retell Widget: No reCAPTCHA token available'), e.a(2, null));
                                        case 8:
                                            return ((e.p = 8), (t = e.v), console.error('Retell Widget: Failed to get reCAPTCHA token:', t), e.a(2, null));
                                    }
                            },
                            e,
                            null,
                        ...
                        return B().w(
                            function (e) {
                                for (;;)
                                    switch (e.n) {
                                        case 0:
                                            if (('none' !== ne.style.display && (ne.style.display = 'none'), Z && (clearTimeout(Z), (Z = null)), 'flex' !== q.style.display)) {
                                                e.n = 1;
                                                break;
                                            }
                                        ...
                                        case 4:
                                            ('ended' !== e.v.chat_status && ((R = n.id), (V = n.history || []), _(R), j(V), (t = !0)), (e.n = 6));
                                            break;
                                        case 5:
                                            ((e.p = 5), e.v, (t = !1));
                                        case 6:
                                        ...
                                        case 7:
                                            ...
                                            return (
                                                'Public key is not allowed for this domain' === a.message
                                                    ? console.error(
                                                    ...
                                                    : console.error('Retell Widget: Failed to create chat:', a.message),
                                                (Y.disabled = !0),
                                        ...
                                        case 9:
                                            ((l = e.v).messages &&
                                                ...
                                                -1 !==
                                                    (r = D.findIndex(function (e) {
                                                        return e.id === R;
                                                    })) && ((D[r].history = V), (D[r].date = new Date().toISOString()), k(D))),
                                                (null === (i = l.messages) || void 0 === i
                                                    ? void 0
                                                    : i.find(function (e) {
                                                          return 'tool_call_invocation' === e.role && 'end_call' === e.name;
                                                      })) &&
                                                    (-1 !==
                                            ...
                                            break;
                                        case 10:
                                            ((e.p = 10), (s = e.v), console.error('Retell Widget: Failed to get initial AI greeting:', s));
                                        case 11:
                                            (ae(),
                                                ie(),
                                    ...
                                    switch (e.n) {
                                        ...
                                        case 4:
                                            ((a = D.find(function (e) {
                                                ...
                                                (Q.style.display = 'none'),
                                                t
                                                    ? ((Y.disabled = !0), (J.querySelector('.retell-send-btn').disabled = !0))
                                                    : ((Y.disabled = !1), (J.querySelector('.retell-send-btn').disabled = !1), ee()));
                                        case 5:
                                            return e.a(2);
                                    }
                            },
                        ...
                        return B().w(function (e) {
                            for (;;)
                                switch (e.n) {
                                    ...
                                    case 2:
                                        ((R = null), (V = []), _(''), j(V), (q.style.display = 'none'), l($, !1), ie(), ae());
                                    case 3:
                                        return e.a(2);
                                }
                        }, e);
                                    ...
                                    switch (e.n) {
                                        ...
                                        case 1:
                                            return (
                                                ...
                                                (g = f ? f.textContent : '+1'),
                                                c && ((c.disabled = !0), (c.textContent = 'Submitting request...')),
                                                (e.p = 2),
                                                (b = ''.concat(g).concat(p)),
                                                (h = {
                                        ...
                                        case 4:
                                            ...
                                            throw new Error(x.message || 'Failed to submit call request');
                                        case 5:
                                            if (x.call_id) {
                                                e.n = 6;
                                                break;
                                        ...
                                        case 6:
                                            (be(), t && (t.value = ''), i && (i.value = ''), l && (l.value = ''), (e.n = 8));
                                            break;
                                        case 7:
                                            ((e.p = 7),
                                                (C = e.v),
                                        ...
                                        case 8:
                                            return ((e.p = 8), (_ = U.getElementById('retell-callback-submit')) && ((_.disabled = !1), (_.textContent = 'Submit Request')), e.f(8));
                                        case 9:
                                            return e.a(2);
                                    }
                            },
            ...
            function ye() {
                var e = i(U, pe, ge, h, x);
                e && (e.firstNameInput, e.lastNameInput, e.phoneInput, e.privacyCheckbox, e.callbackSubmit, e.maybeLaterBtn);
            }
            function xe() {
                                ...
                                for (;;)
                                    switch (e.n) {
                                        case 0:
                                            ...
                                            return e.a(2);
                                        case 1:
                                            ((Y.value = ''), V.push({ role: 'user', content: a }), ae(), j(V));
                                        ...
                                        case 4:
                                            ((e.p = 4),
                                                ...
                                                (i = {
                                                    status: 'error',
                                                    message: (null == p ? void 0 : p.message) || 'Unknown error',
                                                }));
                                        case 5:
                                            ...
                                            if (!i || 'error' !== i.status || 'Chat already ended' !== i.message) {
                                                e.n = 6;
                                                break;
                                            }
                                            return (
                                        ...
                                        case 7:
                                            -1 !==
                                                ...
                                                V.length > 0 &&
                                                ((d = V[V.length - 1].content).length > 40 && (d = d.slice(0, 40) + '...'),
                                                (D[c].title = d),
                                                (D[c].history = V),
