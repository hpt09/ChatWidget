                                ...
                                (l && 'agent' === l.role) ||
                                    (a.forEach(function (n, o) {
                                        ...
                                        ((a.className = 'retell-msg agent-row'),
                                            0 === o
                                                ? (a.innerHTML = "<span class='retell-agent-logo'>".concat(t, "</span><div class='retell-msg agent'>").concat(n.content, '</div>'))
                                                : ((a.className = 'retell-msg agent-row consecutive'),
                                                  (a.innerHTML = "<div class='retell-msg agent' style='margin-left: 36px;'>".concat(n.content, '</div>'))),
                                            e.appendChild(a));
                                    }),
                                    (a = []),
